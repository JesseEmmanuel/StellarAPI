...
>
  <head>
    ...
    <title>Admin Stellar</title>

    <meta name="description" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ url('dist/images/stellar.png') }}" />
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  <span class="app-brand-logo demo">
                    <img src="{{ url('dist/images/stellar.png') }}" alt
                        class="w-px-40 h-auto rounded-circle">
                  </span>
                  <span class="demo text-body fw-bolder"> <h4 class="mb-2">Admin Stellar</h4></span>
                </a>
              </div>
              <!-- /Logo -->
